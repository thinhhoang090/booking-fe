...
function Header({ children }) {
  ...
  return (
    <div class="sb-nav-fixed">
      ...
      style={{transform : open ? "" : "translateX(-225px)" }}
        >
          <nav
            ...
            <div class="sb-sidenav-menu">
              <div class="nav">
                ...
                <a class="nav-link" href="user">
                  <div class="sb-nav-link-icon">
                    <i class="fas fa-user-alt iconmenu"></i>
                  </div>
                  Tài khoản
                </a>
                <a class="nav-link" href="category">
                  <div class="sb-nav-link-icon">
                    <i class="fas fa-list iconmenu"></i>
                  </div>
                  Danh mục
                </a>
                <a
                ...
                >
                  <div class="sb-nav-link-icon">
                    <i class="fas fa-table iconmenu"></i>
                  </div>
                  Phòng
                  <div class="sb-sidenav-arrow">
                    {" "}
                ...
                >
                  <nav class="sb-sidenav-menu-nested nav">
                    ...
                    <a class="nav-link" href="empty-room">
                      Phòng còn trống
                    </a>
                  </nav>
                </div>
                <a class="nav-link" href="dichvu">
                  <div class="sb-nav-link-icon">
                    <i class="fas fa-shopping-bag iconmenu"></i>
                  </div>
                  Dịch vụ
                </a>
                <a class="nav-link" href="tienich">
                  <div class="sb-nav-link-icon">
                    <i class="fa fa-shopping-cart iconmenu"></i>
                  </div>
                  Tiện ích
                </a>
                <a class="nav-link" href="blog">
                  <div class="sb-nav-link-icon">
                    <i class="fas fa-newspaper iconmenu"></i>
                  </div>
                  Bài viết
                </a>
                <a class="nav-link" href="booking">
                  <div class="sb-nav-link-icon">
                    <i class="fas fa-file iconmenu"></i>
                  </div>
                  Lịch đặt
                </a>
                ...
                >
                  <div class="sb-nav-link-icon">
                    <i class="fa fa-key iconmenu"></i>
                  </div>
                  Mật khẩu
                </a>
                <a onClick={logout} class="nav-link" href="#">
                  <div class="sb-nav-link-icon">
                    <i class="fas fa-sign-out-alt iconmenu"></i>
                  </div>
                  Đăng xuất
                </a>
              </div>
        ...
        <div id="layoutSidenav_content"
         style={{ 
            //  paddingRight : open ? '225px' : "0px",
             paddingLeft : open ? '225px' : "0px"
         }}
        >
            ...
            <div class="modal-body row">
              <form method="post" onSubmit={handleChangePass}>
                ...
                <input
                  ...
                  class="form-control"
                />
                <button type="submit" class="btntt">
                  LƯU
                </button>
              </form>
            </div>
